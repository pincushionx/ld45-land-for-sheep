...
namespace Pincushion.LD45
{
    ...
    public class Goat : MonoBehaviour
    {
        ...
        private float hungerRate = 0.025f;
        private float matingRate = 0.05f;
            ...
            if (mate != null)
            {
                ...
                if (distance < matingDistance)
                {
                    ...
                    if (mate.mating == 0f)
                    {
                        ...
                        Goat kid = SceneManager.Instance.AddGoat(position);
        ...
        public void GotDead()
        {
            SceneManager.Instance.RemoveGoat(this);
        ...
        IEnumerator SearchForMate()
        {
            ...
            while (mate == null)
            {
                ...
                mate = SceneManager.Instance.FindNearestGoat(transform.position, this, matingSearchDistance);
            }
